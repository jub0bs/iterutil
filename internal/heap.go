// Package internal contains an implementation of a binary heap;
// it draws heavy inspiration from package [container/heap].
package internal
...
func NewHeap[T any](vs []T, compare func(T, T) int) Heap[T] {
	h := Heap[T]{
		s:       vs,
		compare: compare,
	}
